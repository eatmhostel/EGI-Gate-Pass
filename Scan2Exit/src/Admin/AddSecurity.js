  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.EXPO_PUBLIC_API_URL}/security/add`,
        {
          method: "POST",
    ...
    >
      <View style={styles.mainWrapper}>
        ...
        >
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.infoBox}>
              ...
              <Text style={styles.infoText}>
                The security personnel will receive login credentials via email
          ...
          {/* Dynamic Spacer: Pushes the footer to the bottom of the screen */}
          <View style={styles.footerSpacer} />
        </ScrollView>
      </View>
      
      {/* Footer Wrapper - Adds space between buttons and footer */}
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    ...
    paddingTop: 5,
    paddingBottom: 20,
    flexGrow: 1, // Allows content to expand and push footer down
  },
  ...
  // Spacer specifically to push footer to the bottom
  footerSpacer: {
    flex: 1
  },

  // Wrapper to add space between buttons and footer
  footerWrapper: {
    marginTop: 60, // Increase or decrease this value to adjust the gap
    backgroundColor: "#f3f4f6" // Matches the main background so it looks seamless
  }
});